    ...
    <div className="bg-[#ffecdc]">
      ...
      <div className="font-gilroy ml-24 pt-10">
        <div className="flex flex-row items-center">
          <div className="font-bold text-[#fe6601] text-[100px] ">Kantin Labtek V</div>
        ...
        <div className="font-bold text-[50px] text-[#ff9d5d]">Labtek V</div>
      </div>
      <div>
      <KantinFoodCard startIndex={(5 - 1) * 8} endIndex={5 * 8}/>
      </div>
    </div>
  );
};
